 ...
 *
 * @param method Devi API method to call
 ...
 */
DeviAPI_v1_0.prototype.execute = function (method, availableParams, givenParams, callback) {
	...
	request({
		uri : this.httpUri+'/api/v'+this.version+'/'+method,
		method: 'POST',
		headers : {
